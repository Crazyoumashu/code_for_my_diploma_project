...
public class Utils {
    ...
    public static Bitmap copyBitmap(Bitmap bitmap){return bitmap.copy(bitmap.getConfig(),true);}
    ...
    static public void showPixels(int v){
    ...
    static public Bitmap convert(Bitmap a)
    {
        int w = a.getWidth();
        int h = a.getHeight();
