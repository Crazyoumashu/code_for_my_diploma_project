...
public class ScreenShotUtils {
    ...
    public static String takeScreenShot(Activity pActivity){
        ...
        Log.d("huanghw", "状态栏的高度为："+statusHeight);
        int width = pActivity.getWindowManager().getDefaultDisplay().getWidth();
        int height = (int)width*7/5;  //截图时控制距离，距离屏幕底部多高距离
        bitmap = Bitmap.createBitmap(bitmap,0,statusHeight,width,height);
        Log.d("截图截图截图","截图width:"+width+"截图height"+height+"顶部开始Y坐标"+statusHeight);
    ...
    public static void saveFile(Bitmap bm, String fileName, String path) throws IOException{
        ...
        String subFolder = SAVE_REAL_PATH +fileName1;
